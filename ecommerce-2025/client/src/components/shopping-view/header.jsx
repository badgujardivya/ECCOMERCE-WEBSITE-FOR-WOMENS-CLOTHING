...
function ShoppingHeader() {
  ...
  return (
    <header className=" w-full z-50 border-b bg-background shadow-md">
      <div className="flex h-16 items-center justify-between px-6 md:px-6">
        <Link to="/shop/home" className="flex items-center gap-2">
          <SquareScissors strokeWidth={1} className="h-8 w-8" />
          <span className="font-bold">VAIBHAVI COLLECTION</span>
        </Link>
        <Sheet>
