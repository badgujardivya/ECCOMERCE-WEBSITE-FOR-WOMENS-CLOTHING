...
function ShoppingCheckout() {
  ...
  function validateAndCreateOrder(paymentMethod) {
    ...
    dispatch(createNewOrder(orderData)).then((data) => {
      if (paymentMethod === "paypal") {
        ...
        if (data?.payload?.success) {
          ...
          // Redirect or clear cart logic here if needed
        } else {
          toast({
            title: "Order creation failed. Try again.",
            variant: "destructive",
  ...
  function handleInitiatePaypalPayment() {
    validateAndCreateOrder("paypal");
  }

  function handleCashOnDelivery() {
    validateAndCreateOrder("cashOnDelivery");
  }
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5 p-5">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-4 w-full grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <Button variant="outline" onClick={handleCashOnDelivery} className="w-full">
              Cash on Delivery
            </Button>
          </div>
        </div>
